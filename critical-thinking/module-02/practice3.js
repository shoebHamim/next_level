...
const output=sales.reduce((result,curr)=>{
  const currentObj=result[curr.category]||{}
  currentObj.totalRevenue=(currentObj.totalRevenue||0 )+curr.price*curr.quantity
  currentObj.itemCount=(currentObj.itemCount||0)+1
  result[curr.category]=currentObj
  return result
},{})
